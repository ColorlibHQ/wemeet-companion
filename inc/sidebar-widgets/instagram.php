...
----------------------------------------*/
class wemeet_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('wemeet_instagram_photo',esc_html__('[ Wemeet ] Intagram Photo','wemeet-companion'),array(
			'description' => esc_html__('Wemeet Instagram Photo Widget','wemeet-companion'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'wemeet-companion');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'wemeet-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'wemeet-companion'); ?></label>
...
if(!function_exists('wemeet_instagram_widgets')):
	function wemeet_instagram_widgets(){
		register_widget('wemeet_instagram_photo');
	}
	add_action('widgets_init','wemeet_instagram_widgets');
endif;
