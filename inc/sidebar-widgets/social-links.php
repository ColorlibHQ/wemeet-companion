...
class Wemeet_social_links extends WP_Widget {
    ...
    function __construct() {
        ...
        esc_html__( '[ Wemeet ] Social Links', 'wemeet-companion' ),

        // Widget description
        array( 'description' => esc_html__( 'Add footer social links.', 'wemeet-companion' ), )
        );
    ...
    public function form( $instance ) {
        ...
        $title = isset( $instance[ 'title' ] ) ? $instance[ 'title' ] : esc_html__( 'Follow Us', 'wemeet-companion' );
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'facebook' ) ); ?>"><?php esc_html_e( 'Facebook URL:' ,'wemeet-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'twitter' ) ); ?>"><?php esc_html_e( 'Twitter URL:' ,'wemeet-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'linkedin' ) ); ?>"><?php esc_html_e( 'Linkedin URL:' ,'wemeet-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'instagram' ) ); ?>"><?php esc_html_e( 'Instagram URL:' ,'wemeet-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'dribbble' ) ); ?>"><?php esc_html_e( 'Dribbble URL:' ,'wemeet-companion'); ?></label>
...
} // Class wemeet_social_links ends here


// Register and load the widget
function wemeet_social_links_widget_load() {
	register_widget( 'Wemeet_social_links' );
}
add_action( 'widgets_init', 'wemeet_social_links_widget_load' );