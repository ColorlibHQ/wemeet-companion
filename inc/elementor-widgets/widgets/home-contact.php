...
/**
 *
 * Wemeet elementor home contact section widget.
 *
 * @since 1.0
 */
class Wemeet_Home_Contact extends Widget_Base {

	public function get_name() {
		return 'wemeet-home-contact-section';
	}

	public function get_title() {
		return __( 'Home Contact', 'wemeet-companion' );
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Home Contact Section', 'wemeet-companion' ),
            ]
        );
        $this->add_control(
            'left_img',
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Right Section', 'wemeet-companion' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'label_block' => true,
                'default'   => esc_html__( 'Contact Us', 'wemeet-companion' ),
            ]
        );
        $this->add_control(
            'sec_title',
            [
                ...
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default'   => esc_html__( 'Send your message', 'wemeet-companion' ),
            ]
        );
        ...
        $this->start_controls_section(
            'home_contact_sec_style', [
                'label' => __( 'Home Contact Section Styles', 'wemeet-companion' ),
        ...
        $this->add_control(
			'btn_hvr_border_bg_col', [
				'label' => __( 'Button Hover Border & Bg Color', 'wemeet-companion' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
    ...
    $left_img       = !empty( $settings['left_img']['id'] ) ? wp_get_attachment_image( $settings['left_img']['id'], 'wemeet_message_img_585x700', '', array('alt' => 'home contact left image' ) ) : '';
