...
/**
 *
 * Wemeet elementor faq section section widget.
 *
 * @since 1.0
 */
class Wemeet_Faq_Section extends Widget_Base {

	public function get_name() {
		return 'wemeet-faq-section';
	}

	public function get_title() {
		return __( 'Faq Section', 'wemeet-companion' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'faq_contents',
			[
				'label' => __( 'Faq content', 'wemeet-companion' ),
			]
        );
        $this->add_control(
            'sec_title',
            [
                ...
                'label_block' => true,
                'default' => esc_html__( 'Frequently Ask Question', 'wemeet-companion' )
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Faq Items', 'wemeet-companion' ),
		...
		$this->add_control(
            'faq_items', [
                ...
                'fields' => [
                    [
                        'name' => 'faq_title',
                        'label' => __( 'Faq Title', 'wemeet-companion' ),
                        'label_block' => true,
                    ...
                    [
                        'name' => 'faq_text',
                        'label' => __( 'Faq Text', 'wemeet-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXTAREA,
    ...
    $info_icon = WEMEET_DIR_IMGS_URI . 'info-icon.png';
    ?>
