...
/**
 *
 * Wemeet Review Contents section widget.
 *
 * @since 1.0
 */
class Wemeet_Review_Contents extends Widget_Base {

	public function get_name() {
		return 'wemeet-review-contents';
	}

	public function get_title() {
		return __( 'Review Contents', 'wemeet-companion' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'reviews_content',
			[
				'label' => __( 'Review Contents', 'wemeet-companion' ),
			]
        );
        ...
        $this->add_control(
            'bg_img',
            [
                'label' => esc_html__( 'Section Bg Image', 'wemeet-companion' ),
		...
		$this->add_control(
            'reviews_contents', [
                ...
                'fields' => [
                    [
                        'name' => 'reviewr_img',
                        'label' => __( 'Reviewer Image', 'wemeet-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::MEDIA,
                        'default' => [
                            'url' => Utils::get_placeholder_image_src()
                    ...
                    [
                        'name' => 'review_txt',
                        'label' => __( 'Review Text', 'wemeet-companion' ),
                        'label_block' => true,
                    ...
                    [
                        'name' => 'reviewer_name',
                        'label' => __( 'Reviewer Name', 'wemeet-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( '- MITHILA', 'wemeet-companion' ),
                    ],
                    [
                        'name' => 'reviewer_designation',
                        'label' => __( 'Reviewer Designation', 'wemeet-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( 'Designer at Colorlib', 'wemeet-companion' ),
                    ],
                ],
                'default'   => [
                    [
                        ...
                        'reviewer_name'         => __( '- MITHILA', 'wemeet-companion' ),
                        'reviewer_designation'  => __( 'Designer at Colorlib', 'wemeet-companion' ),
                    ],
                    [
                        'reviewr_img'           => [
                            'url'               => Utils::get_placeholder_image_src(),
        ...
        $this->start_controls_section(
            'style_title', [
                'label' => __( 'Style Review Section', 'wemeet-companion' ),
    ...
    <div class="testmonial_area testimonial_bg overlay2" <?php echo wemeet_inline_bg_img( esc_url( $bg_img ) ); ?>>
                    ...
                    <div class="testmonial_active owl-carousel">
                        ...
                        if( is_array( $reviews ) && count( $reviews ) > 0 ){
                            foreach ( $reviews as $review ) {
                                ...
                                $reviewr_img   = !empty( $review['reviewr_img']['id'] ) ? wp_get_attachment_image( $review['reviewr_img']['id'], 'wemeet_client_img_116x116', '', array('alt' => $reviewer_name . ' image' ) ) : '';
